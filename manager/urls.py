...
urlpatterns = [
    ...
    url(r'^panel/manager/delete/(?P<pk>\d+)/$', views.manager_del, name='manager_del'),
    url(r'^panel/manager/del/(?P<name>.*)/$', views.manager_group_del, name='manager_group_del'),
    ...
    url(r'^panel/manager/userrs/perms/delete/(?P<pk>\d+)/(?P<name>.*)/$', views.users_perms_del, name='users_perms_del'),
    url(r'^panel/manager/perms/add/(?P<pk>\d+)/$', views.users_perms_add, name='users_perms_add'),
    url(r'^panel/manager/perms/add/to/delete/(?P<name>.*)/$', views.groups_perms, name='groups_perms'),
    url(r'^panel/manager/perms/group/to/delete/(?P<name>.*)/(?P<gname>.*)/$', views.groups_perms_del, name='groups_perms_del'),
    url(r'^panel/manager/perms/group/to/add/(?P<name>.*)/$', views.groups_perms_add, name='groups_perms_add'),
]
